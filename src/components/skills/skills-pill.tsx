  ...
  return (
    <div className="group flex w-max items-center gap-3 overflow-hidden rounded-xl border-2 border-accent/30 bg-gradient-to-r from-[#f4f6ff] to-accent/10 px-5 py-3 text-sm shadow-lg transition-all duration-300 hover:scale-105 hover:border-accent hover:shadow-xl hover:shadow-accent/20 dark:from-[#15182b] dark:to-accent/20 sm:text-base md:px-6 md:py-3 md:text-lg">
      ...
      <span
        ...
        style={{ textShadow: "0 1px 2px #f8faff, 0 0 2px hsl(var(--accent))" }}
      >
        {name}
      </span>
    </div>
